...
import { ALL_BLOOD_TYPES } from '../utils/bloodTypeMap';
...
function generateToken(id: string, role: Role): string {
...
router.post('/register', async (req: Request, res: Response): Promise<void> => {
  try {
    const { name, email, password, role, hospitalOrBankDetails }: RegisterBody = req.body;
